            ...
            Object.keys(this.fields).forEach(name => {
                ...
                if (name !== 'id' && field.store === true) {
                    if (['integer', 'float', 'monetary'].includes(field.type) || additionalMeasures.includes(name)) {
                        if(name ==='budget_total_x')
                        {
                            measures[name] = {
                                change_default: false,
                                company_dependent: false,
                                depends: ["opportunity_total_cost", "budget_currency"],
                                group_operator: "sum",
                                manual: false,
                                name: "budget_total",
                                readonly: true,
                        ...
                        else if(name === 'margin_after_travel')
                        {
                            measures[name] = {
                                change_default: false,
                                company_dependent: false,
                                depends: ["budget_total", "amount_untaxed", "travel_expenses"],
                                group_operator: "sum",
                                manual: false,
                                name: "margin_after_travel",
                                readonly: true,
                                required: false,
                                searchable: true,
                                sortable: true,

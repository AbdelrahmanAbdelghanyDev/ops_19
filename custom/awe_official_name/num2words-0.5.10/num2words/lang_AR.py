...
CURRENCY_KWD = [("دينار", "ديناران", "دينارات", "ديناراً"),
                ("فلس", "فلسان", "فلس", "فلساً")]
CURRENCY_USD = [("دولار", "دولاران", "دولارات", "دولاراً"),
                ("سنت", "سنتان", "سنت", "سنتاً")]
CURRENCY_EUR = [("يورو", "يورو", "يورو", "يورو"),
                ("سنت", "سنتان", "سنت", "سنتاً")]
...
class Num2Word_AR(object):
    ...
    def __init__(self):
        ...
        self.arabicFeminineOnes = [
            ...
            "تسع",
            "عشرة", "إحدى عشرة", "إثنى عشرة", "ثلاث عشرة", "أربع عشرة",
        ...
        self.arabicTwos = [
            "مئتان", "ألفان", "مليونا", "ملياران", "تريليونان", "كوادريليونان",
    ...
    def set_currency_prefer(self, currency):
        if currency == 'EGP':
            ...
            self.currency_unit = CURRENCY_EUR[0]
            self.currency_subunit = CURRENCY_EUR[1]
        elif currency == 'AED':
            self.currency_unit = CURRENCY_AED[0]
            self.currency_subunit = CURRENCY_AED[1]
        else:
            self.currency_unit = CURRENCY_SR[0]
            self.currency_subunit = CURRENCY_SR[1]
